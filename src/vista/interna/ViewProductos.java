...
public class ViewProductos extends javax.swing.JInternalFrame {
    ...
    public JButton getBtnguardarPrd() {
        return btnguardarPrd;
    }
    ...
    public JButton getBtnlimpiarProdbsq() {
        return btnlimpiarProdbsq;
    }

    public void setBtnlimpiarProdbsq(JButton btnlimpiarProdbsq) {
        this.btnlimpiarProdbsq = btnlimpiarProdbsq;
    }

    public JCheckBox getChekBsqProd() {
        return chekBsqProd;
    }

    public void setChekBsqProd(JCheckBox chekBsqProd) {
        this.chekBsqProd = chekBsqProd;
    }
    ...
    public JSpinner getSpncantidadProd() {
        return spncantidadProd;
    }

    public void setSpncantidadProd(JSpinner spncantidadProd) {
        this.spncantidadProd = spncantidadProd;
    }
    ...
    public JTextField getTxtBsqProd() {
        return txtBsqProd;
    }

    public void setTxtBsqProd(JTextField txtBsqProd) {
        this.txtBsqProd = txtBsqProd;
    }
    ...
    private void initComponents() {
        ...
        btnguardarPrd = new javax.swing.JButton();
        ...
        txtBsqProd = new javax.swing.JTextField();
        btnbuscarProd = new javax.swing.JButton();
        btnlimpiarProdbsq = new javax.swing.JButton();
        chekBsqProd = new javax.swing.JCheckBox();
        ...
        setIconifiable(true);
        setTitle("Productos");
        setPreferredSize(new java.awt.Dimension(960, 442));
        ...
        txtnombreProd.setBackground(new java.awt.Color(249, 247, 250));
        txtnombreProd.setFont(new java.awt.Font("Leelawadee UI", 0, 11)); // NOI18N
        txtnombreProd.setBorder(null);
        jPanel2.add(txtnombreProd, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 60, 290, -1));

        txtprecioProd.setBackground(new java.awt.Color(249, 247, 250));
        txtprecioProd.setFont(new java.awt.Font("Leelawadee UI", 0, 11)); // NOI18N
        txtprecioProd.setBorder(null);
        jPanel2.add(txtprecioProd, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 110, 290, -1));

        btnguardarPrd.setBackground(new java.awt.Color(249, 247, 250));
        btnguardarPrd.setFont(new java.awt.Font("Dialog", 1, 10)); // NOI18N
        btnguardarPrd.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/icon-save.png"))); // NOI18N
        btnguardarPrd.setToolTipText("Crear");
        btnguardarPrd.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
        jPanel2.add(btnguardarPrd, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 230, 40, 30));

        btneditarProd.setBackground(new java.awt.Color(249, 247, 250));
        btneditarProd.setFont(new java.awt.Font("Dialog", 1, 10)); // NOI18N
        btneditarProd.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/icon-actualizar.png"))); // NOI18N
        btneditarProd.setToolTipText("Actualizar");
        btneditarProd.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
        jPanel2.add(btneditarProd, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 230, 40, 30));

        btneliminarProd.setBackground(new java.awt.Color(249, 247, 250));
        btneliminarProd.setFont(new java.awt.Font("Dialog", 1, 10)); // NOI18N
        btneliminarProd.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/icon-delete.png"))); // NOI18N
        ...
        jPanel2.add(btneliminarProd, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 230, 40, 30));

        btnlimpiarProd.setBackground(new java.awt.Color(249, 247, 250));
        btnlimpiarProd.setFont(new java.awt.Font("Dialog", 1, 10)); // NOI18N
        btnlimpiarProd.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/icon-clear.png"))); // NOI18N
        btnlimpiarProd.setToolTipText("Limpiar");
        btnlimpiarProd.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
        jPanel2.add(btnlimpiarProd, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 230, 40, 30));
        ...
        jPanel2.add(jSeparator3, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 80, 290, -1));

        jSeparator6.setForeground(new java.awt.Color(204, 204, 204));
        jPanel2.add(jSeparator6, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 130, 290, -1));

        jSeparator7.setForeground(new java.awt.Color(204, 204, 204));
        jPanel2.add(jSeparator7, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 180, 290, -1));
        ...
        jPanel2.add(jSeparator4, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 30, 60, 380));

        spncantidadProd.setFont(new java.awt.Font("Leelawadee UI", 1, 11)); // NOI18N
        spncantidadProd.setModel(new javax.swing.SpinnerNumberModel(0, 0, 100000, 1));
        spncantidadProd.setBorder(null);
        jPanel2.add(spncantidadProd, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 160, 290, 20));
        ...
        jLabel8.setText("Búsqueda de Productos");
        ...
        txtBsqProd.setBackground(new java.awt.Color(249, 247, 250));
        txtBsqProd.setFont(new java.awt.Font("Leelawadee UI", 0, 11)); // NOI18N
        txtBsqProd.setBorder(null);
        jPanel6.add(txtBsqProd, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 70, 250, -1));
        ...
        btnbuscarProd.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/sear.png"))); // NOI18N
        btnbuscarProd.setText("Buscar");
        btnbuscarProd.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
        jPanel6.add(btnbuscarProd, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 60, 80, 30));

        btnlimpiarProdbsq.setBackground(new java.awt.Color(249, 247, 250));
        btnlimpiarProdbsq.setFont(new java.awt.Font("Dialog", 1, 10)); // NOI18N
        btnlimpiarProdbsq.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/icon-clear.png"))); // NOI18N
        btnlimpiarProdbsq.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
        jPanel6.add(btnlimpiarProdbsq, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 60, 40, 30));

        chekBsqProd.setBackground(new java.awt.Color(249, 247, 250));
        chekBsqProd.setFont(new java.awt.Font("Leelawadee UI", 1, 10)); // NOI18N
        chekBsqProd.setText("Mostrar Todos");
        chekBsqProd.setBorder(null);
        jPanel6.add(chekBsqProd, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 60, 110, 30));
        ...
        tblProductos.setFont(new java.awt.Font("Leelawadee UI", 0, 11)); // NOI18N
        ...
        btncancelarProd.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/cross.gif"))); // NOI18N
        ...
        jPanel6.add(btncancelarProd, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 350, 80, 30));
    ...
    private javax.swing.JTextField txtBsqProd;
