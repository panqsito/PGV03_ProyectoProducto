...
public class UsuarioJpaController implements Serializable {
    ...
    public void create(Usuario usuario) {
        ...
        try {
            ...
            Persona idpersonau = usuario.getIdpersonau();
            if (idpersonau != null) {
                idpersonau = em.getReference(idpersonau.getClass(), idpersonau.getIdpersona());
                usuario.setIdpersonau(idpersonau);
            }
            em.persist(usuario);
            if (idpersonau != null) {
    ...
    public void edit(Usuario usuario) throws NonexistentEntityException, Exception {
        ...
        try {
            ...
            Persona idpersonauOld = persistentUsuario.getIdpersonau();
            Persona idpersonauNew = usuario.getIdpersonau();
            if (idpersonauNew != null) {
                idpersonauNew = em.getReference(idpersonauNew.getClass(), idpersonauNew.getIdpersona());
                usuario.setIdpersonau(idpersonauNew);
            }
    ...
    public List<Usuario> buscarUsers(String nombre) {
